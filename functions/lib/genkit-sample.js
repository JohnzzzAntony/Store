...
const menuSuggestionFlow = ai.defineFlow({
    ...
    inputSchema: genkit_1.z.string().describe("An ecommerce theme").default("Perfumes"),
    outputSchema: genkit_1.z.string(),
    streamSchema: genkit_1.z.string(),
}, async (subject, { sendChunk }) => {
    var _a, e_1, _b, _c;
    // Construct a request and send it to the model API.
    const prompt = `Suggest an item for the menu of a ${subject} themed perfume ecommerce`;
